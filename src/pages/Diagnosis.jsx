...
import { ArrowRight, RefreshCcw, ChevronRight } from 'lucide-react';
...
const questions = [
  // 軸1: D(飲み派) vs F(食べ派)
  { id: 1, text: '飲み会ではお酒を飲むのが一番の楽しみだ。', axis: 'DF', direction: 1 },
  { id: 2, text: '食べ物のラインナップが何より重要だと思う。', axis: 'DF', direction: -1 },
  // 軸2: G(ガッツリ) vs K(控えめ)
  { id: 3, text: '終電を逃してでも飲み続けたいタイプだ。', axis: 'GK', direction: 1 },
  { id: 4, text: '二日酔いにならない程度にセーブして楽しみたい。', axis: 'GK', direction: -1 },
  // 軸3: E(大人数) vs I(少人数)
  { id: 5, text: '大人数でワイワイ盛り上がるのが好きだ。', axis: 'EI', direction: 1 },
  { id: 6, text: '気心知れた少人数の方が断然楽しめる。', axis: 'EI', direction: -1 },
  // 軸4: N(冒険) vs T(定番)
  { id: 7, text: '新しいお店やメニューをどんどん試したい。', axis: 'NT', direction: 1 },
  { id: 8, text: 'いつものお店・定番メニューが一番安心する。', axis: 'NT', direction: -1 },
];
...
/* ══════════════════════════════════════════
   ...
   ══════════════════════════════════════════ */
const axisLabels = {
  DF: { pos: '飲', neg: '食', posLabel: '飲み派', negLabel: '食べ派' },
  GK: { pos: '豪', neg: '控', posLabel: 'ガッツリ', negLabel: '控えめ' },
  EI: { pos: '陽', neg: '陰', posLabel: '大人数', negLabel: '少人数' },
  NT: { pos: '冒', neg: '安', posLabel: '冒険', negLabel: '定番' },
};
...
// グループカラー: DG=green, DK=purple, FG=yellow, FK=blue
const typeDefinitions = {
  // ── DG グループ（飲み × ガッツリ）── 🟢 green
  DGEN: {
    name: '宴会キング',
    code: 'DGEN', group: 'DG', colorClass: 'green',
  ...
  DGET: {
    name: '飲み会番長',
    code: 'DGET', group: 'DG', colorClass: 'green',
  ...
  DGIN: {
    name: '探求の酒豪',
    code: 'DGIN', group: 'DG', colorClass: 'green',
  ...
  DGIT: {
    name: '酒場の哲学者',
    code: 'DGIT', group: 'DG', colorClass: 'green',
  ...
  DKEN: {
    name: 'カクテル外交官',
    code: 'DKEN', group: 'DK', colorClass: 'purple',
  ...
  DKET: {
    name: '乾杯マスター',
    code: 'DKET', group: 'DK', colorClass: 'purple',
  ...
  DKIN: {
    name: 'ワイン通の隠者',
    code: 'DKIN', group: 'DK', colorClass: 'purple',
  ...
  DKIT: {
    name: '晩酌の達人',
    code: 'DKIT', group: 'DK', colorClass: 'purple',
  ...
  FGEN: {
    name: 'グルメ冒険家',
    code: 'FGEN', group: 'FG', colorClass: 'yellow',
  ...
  FGET: {
    name: '爆食ファイター',
    code: 'FGET', group: 'FG', colorClass: 'yellow',
  ...
  FGIN: {
    name: '美食探検家',
    code: 'FGIN', group: 'FG', colorClass: 'yellow',
  ...
  FGIT: {
    name: '大食いの守護者',
    code: 'FGIT', group: 'FG', colorClass: 'yellow',
  ...
  FKEN: {
    name: 'ヘルシー社交家',
    code: 'FKEN', group: 'FK', colorClass: 'blue',
  ...
  FKET: {
    name: 'おつまみ奉行',
    code: 'FKET', group: 'FK', colorClass: 'blue',
  ...
  FKIN: {
    name: '隠れ家グルメ',
    code: 'FKIN', group: 'FK', colorClass: 'blue',
  ...
  FKIT: {
    name: 'おうち居酒屋派',
    code: 'FKIT', group: 'FK', colorClass: 'blue',
...
function diagnose(answers) {
  ...
  const maxPerAxis = 6; // 2問 × 最大3pt
  const pct = (axis) => Math.round(50 + (axisScores[axis] / maxPerAxis) * 50);
  ...
  return (
    <div className="page-container">
      <div className="diagnosis-header">
        <h2>宴会タイプ診断</h2>
        <p className="text-muted">8つの質問に答えて、16タイプから自分を見つけよう</p>
      </div>
